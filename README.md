...
<img align="right" hegiht="60" alt="UTM logo" src="images/utm-logo.png">В этом репозитории представлены работы по дискретной математике, выполненные мной, студенткой университета UTM, группы TI-202FR, Гамурарь Яной.
